...
export default function CTA() {
  ...
  return (
    <section id="contact" className="relative overflow-hidden py-32 lg:py-44">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_30%,#08080A_80%)]" />
      ...
      <div ref={ref} className="reveal relative z-10 mx-auto max-w-3xl px-6 text-center">
        ...
        <h2 className="text-[clamp(2.2rem,6vw,4.5rem)] font-semibold leading-[1.02] tracking-[-0.03em] text-[#F4F4F2]">
          Let's engineer
          <br />
          your <span className="font-serif-display italic text-gradient">advantage.</span>
        </h2>
        <p className="mx-auto mt-7 max-w-md text-[16px] leading-[1.6] text-[#9A9AA2]">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            href="#top"
            className="inline-flex items-center gap-2 rounded-full border border-white/15 px-7 py-4 text-[15px] font-medium text-[#F4F4F2] hover:bg-white/[0.04] hover:border-white/25 transition-all duration-300"
          >
            Book a call
          </a>
        </div>
