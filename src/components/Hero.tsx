...
export default function Hero() {
  ...
  return (
    <section id="top" className="relative min-h-[100svh] w-full overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#0A0A0B] to-transparent" />

      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10 min-h-[100svh] flex flex-col justify-center pt-24 pb-28">
        <div className="max-w-3xl">
          <div className="reveal is-visible mb-6 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5 text-[12px] text-[#9A9AA0]">
          ...
          <h1 className="text-[clamp(2.6rem,7vw,5.5rem)] font-semibold leading-[1.02] tracking-[-0.03em] text-[#F5F5F3]">
            Engineering
            <br />
            your <span className="text-gradient">advantage.</span>
          </h1>

          <p className="mt-7 max-w-xl text-[17px] leading-[1.6] text-[#9A9AA0]">
          ...
          <div className="mt-9 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <a
              ref={primaryRef}
              href="#contact"
              className="group relative inline-flex items-center gap-2 rounded-full bg-gradient-to-br from-[#5B5BF5] to-[#8B7CF6] px-6 py-3.5 text-[14px] font-medium text-white glow-accent transition-shadow duration-500"
            ...
            <a
              ref={ghostRef}
              href="#work"
              className="inline-flex items-center gap-2 rounded-full border border-white/15 px-6 py-3.5 text-[14px] font-medium text-[#F5F5F3] hover:bg-white/[0.04] hover:border-white/25 transition-all duration-300"
              style={{ willChange: 'transform' }}
            >
              See selected work
            </a>
      ...
      <a
        href="#reach"
        className="absolute bottom-7 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-2 text-[#5C5C63] hover:text-[#9A9AA0] transition-colors duration-300"
